...
$(document).ready(function () {
  ...
  var input = $("#nav-search input"); // hide menu items and display search when icon clicked
...
$(document).ready(function () {
  ...
  var next = $("#nav-pm .nav-link.next"); // nav title

  var title = $('#nav-pm-title'); // active tab

  var currentTab = $("#nav-pm-content").find(".active"); // prev click event
  ...
  function moveTab(direction) {
    currentTab = $("#nav-pm-content").find(".active"); // next btn clicked
    ...
    if (direction == "next") {
      ...
      if (currentTab.next().length) {
        ...
        currentTab.next().addClass('active show'); // change id and href of prev & next btn
      ...
      if (currentTab.prev().length) {
        ...
        currentTab.removeClass('active show');
        currentTab.prev().addClass('active show'); // change id and href of prev & next btn
...
__webpack_require__(/*! ./nav.js */ "./src/assets/js/nav.js");

__webpack_require__(/*! ./plans-media.js */ "./src/assets/js/plans-media.js");

jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation(); // pages/plans-media.html

jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {// const title = $('#nav-pm-title');
  //
